              ...
              if (snapshot.hasData) {
                ...
                return Column(
                    ...
                    children: [
                      ...
                      if (snapshot.data!.meta_data[1]['value'].toString() !=
                          'No' ||
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            launch(snapshot.data!.meta_data[1]['value']
                                .toString());
                          },
                          child: Text(
                      ...
                      if(snapshot.data!.meta_data[4]['value']=='null')
                        ElevatedButton(
                          child: Text('Add Reciept Number',style: TextStyle(color: Colors.white,fontSize: 16),),
                          onPressed: () {
                            showGeneralDialog(
